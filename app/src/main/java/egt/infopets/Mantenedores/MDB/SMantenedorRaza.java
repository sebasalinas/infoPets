...
public class SMantenedorRaza extends AsyncTask<String, Void, Void> {
        ...
        switch (params[0].toString()){
            case "insert":
                try {
                    ...
                    String METHOD_NAME = "insertarRaza";
                    String SOAP_ACTION = "http://tempuri.org/insertarRaza";
                    //------------------------
                    SoapObject request = new SoapObject(NAMESPACE, METHOD_NAME);

                    //----------Modificar
                    request.addProperty("descripcion", params[1].toString());
                    request.addProperty("especie", params[2].toString());
                    //------------------------
